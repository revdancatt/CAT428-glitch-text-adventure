"text-glitch alpha version 0.2.5" by Rev Dan Catt
...
This is a very alpha text adventure port of the MMO game Glitch into the Inform7 language. The region of Alakol with the included items is about the maximum size the Z-Code virtual machine can handle (Glulx can handle it fine fwiw).

Nothing is particularly interactive at the moment, hoping to add some planting, watering, petting and harvesting of trees and mining of rocks soon.

More notes and/or to fork and make pull requests on the source head over to Github: https://github.com/revdancatt/cat428-glitch-text-adventure
...
Natural Resources are kinds of item.
...
In Navran Dissent is a Kitchen Tools Vendor, a shrine to Zille and a wood tree.
...
In Ojan Repine is an Alchemical Goods Vendor, a shrine to Tii, a bean tree and a fruit tree.
...
In Pinnan Glimpse is a Gardening Goods Vendor, a shrine to Pot, a patch, four metal rocks and a dullite rock.
...
In Semsan Simile is an Animal Goods Vendor, a shrine to Humbaba, four metal rocks and a beryl rock.
...
In Simean Dims is a Kitchen Tools Vendor, a shrine to Zilla, three egg plants, three metal rocks and two beryl rocks.
...
In Stopan Winnow is an Animal Goods Vendor, a shrine to Lem, two wood trees and a fruit tree.
...
In Stora Rede is a Hardware Vendor, a shrine to Friendly, a bean tree, a spice plant and a fruit tree.
